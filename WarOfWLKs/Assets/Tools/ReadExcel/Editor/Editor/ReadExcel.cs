...
public class ReadExcel : EditorWindow
{
    ...
    private void CreateEntity()
    {
        var copyFilePath = isSeparated
            ? "Assets/Tools/ReadExcel/Editor/Editor/EntityTemplate2.txt"
            : "Assets/Tools/ReadExcel/Editor/Editor/EntityTemplate.txt";

        Directory.CreateDirectory("Assets/Tools/ReadExcel/Config/Resources/DataEntity/");
        if (isSeparated)
        {
            foreach (var sheet in sheetList)
            {
                ...
                File.WriteAllText("Assets/Tools/ReadExcel/Config/Resources/DataEntity/" + SN + ".cs",
                    sb.ToString());
            }
        }
        else
        {
            ...
            foreach (var sheet in sheetList)
            {
                if (sheet.isEnable)
                {
                    ...
                    File.WriteAllText("Assets/Tools/ReadExcel/Config/Resources/DataEntity/" + scriptName + ".cs",
                        sb.ToString());
                    return;
                }
            }
    ...
    {
        var copyFilePath = isSeparated
            ? "Assets/Tools/ReadExcel/Editor/Editor/ExportTemplate2.txt"
            : "Assets/Tools/ReadExcel/Editor/Editor/ExportTemplate.txt";

        Directory.CreateDirectory("Assets/Tools/ReadExcel/Editor/Importer/");
        if (isSeparated)
        {
            foreach (var sheet in sheetList)
            {
                ...
                var copyScript = File.ReadAllText(copyFilePath);
                var SN = scriptName + "_" + sheet.name;
                var exportAssetDirectry = "Assets/Tools/ReadExcel/Config/Resources/DataConfig/" + SN;
                ...
                File.WriteAllText("Assets/Tools/ReadExcel/Editor/Importer/" + SN + "_Importer" + ".cs", copyScript);
            }
        }
        else
        {
            foreach (var sheet in sheetList)
            {
                ...
                {
                    var copyScript = File.ReadAllText(copyFilePath);
                    var exportAssetDirectry = "Assets/Tools/ReadExcel/Config/Resources/DataConfig/" + scriptName;
                    var builder = CreatImporterBuilder(sheet.name);
                    copyScript = copyScript.Replace("$IMPORT_PATH$", excelFile.filePath);
                    ...
                    File.WriteAllText("Assets/Tools/ReadExcel/Editor/Importer/" + scriptName + "_Importer" + ".cs",
                        copyScript);
                    return;
                }
            }
    ...
    {
        var scriptObjs = Directory.GetFiles("Assets/Tools/ReadExcel/Config/Resources/DataConfig/", "*.asset");
        var scriptEntity = Directory.GetFiles("Assets/Tools/ReadExcel/Config/Resources/DataEntity/", "*.cs");
        ...
        var sb = new StringBuilder(File.ReadAllText("Assets/Tools/ReadExcel/Editor/Editor/ExcelDataInit.txt"));
        sb.Replace("$ResourcesScriptObject$", replaceSB.ToString());
        File.WriteAllText("Assets/Tools/ReadExcel/Config/Resources/" + "ExcelDataInit" + ".cs", sb.ToString());
