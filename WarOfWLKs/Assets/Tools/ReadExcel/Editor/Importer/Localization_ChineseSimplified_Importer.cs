        ...
        foreach (string asset in importedAssets)
        {
            ...
            using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite))
            {
				...
				if (Path.GetExtension (filePath) == ".xls") {
					...
					if (!Directory.Exists("Assets/Tools/ReadExcel/Config/Resources/DataConfig/"))
            	    {
            	        Directory.CreateDirectory("Assets/Tools/ReadExcel/Config/Resources/DataConfig/");
            	    }
                    var exportPath = "Assets/Tools/ReadExcel/Config/Resources/DataConfig/Localization_ChineseSimplified" + ".asset";
