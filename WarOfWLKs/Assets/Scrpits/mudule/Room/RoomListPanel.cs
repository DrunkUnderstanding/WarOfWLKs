...
public class RoomListPanel : BasePanel
{
	...
	{
		skinPath = "Prefabs/UI/Panels/RoomListPanel";
	...
	{
		//寻找组件
		idText = skin.transform.Find("BgImage/InfoPanel/IdBg/IdText").GetComponent<Text>();
		...
		//显示id
		idText.text = GameManager.Instance.ctrllerId;
		//按钮事件
	...
	public void OnMsgCreateRoom(MsgBase msgBase)
	{
		...
		if (msg.result == 0)
		{
			PanelManager.Instance.Open<TipPanel>("创建成功");
			PanelManager.Instance.Open<RoomPanel>();
			Close();
		}
		//创建房间失败
