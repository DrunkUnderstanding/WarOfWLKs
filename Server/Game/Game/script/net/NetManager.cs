...
class NetManager
{
    ...
    //Timer间隔
    public static float timerInterval = 0.5f;
    ...
    public static void StartLoop(int listenPort)
    {
        ...
        //Bind
        IPAddress ipAdr = IPAddress.Parse("172.23.149.225");
    ...
    public static void ReadClientfd(Socket clientfd)
    {
        ...
        try
        {
            if (clientfd == null) Console.WriteLine("Clientfd is null");
    ...
    public static void OnReceiveData(ClientState state)
    {
        ...
        //解析协议名
        int nameCount = 0;
        if (readBuff == null) Console.WriteLine("ReadBuff is null!");

        Console.WriteLine(readBuff.remain);
        string protoName = MsgBase.DecodeName(readBuff.bytes, readBuff.readIdx, out nameCount);
        //Console.WriteLine(protoName + " " + state.socket.RemoteEndPoint);
        if (protoName == "")
        {
    ...
    public static void Send(ClientState cs, MsgBase msg)
    {
        ...
        try
        {
            //Console.WriteLine("[Send]" + msg.ToString() + " " + cs.socket.RemoteEndPoint.ToString() + "：" + DateTime.Now.ToOADate().ToString());
